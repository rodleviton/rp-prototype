...
class ChevronDown extends React.PureComponent<IProps> {
  public render() {
    ...
    return (
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <path
          ...
          fill={fillColour}
          fillRule="nonzero"
          transform="translate(8.007396, 8.000000) rotate(90.000000) translate(-8.007396, -8.000000) "
        />
      </g>
    );
  }
...
export default withStyles(styles, { withTheme: true })(ChevronDown);
