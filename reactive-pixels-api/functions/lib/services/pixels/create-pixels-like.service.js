...
function createPixelsLikeService(request, response, db, decodedIdToken) {
  ...
  Promise.all([
    actions_1.updatePixelsLikes(
      ...
      loggedInUserId,
      pixelsToLikeId,
      TogglePixelsLikeActions.Create
    ),
...
exports.default = createPixelsLikeService;
//# sourceMappingURL=create-pixels-like.service.js.map
